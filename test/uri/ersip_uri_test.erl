...
parse_fail_test() ->
    ...
    ?assertMatch({error, {invalid_sip_uri, {invalid_host, {garbage_at_the_end, <<"@">>}}}}, ersip_uri:parse(<<"sip:a@b@">>)),
    ?assertMatch({error, {invalid_sip_uri, {invalid_host, {garbage_at_the_end, <<"@">>}}}}, ersip_uri:parse(<<"sip:a@b@:5090">>)),
