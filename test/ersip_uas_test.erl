...
uas_reliable_test() ->
    Tid = <<"transaction id">>,
    { UAS0, SideEffects0 } = ersip_uas:new(Tid, reliable, message, #{}),
    ...
    %% ID is set:
    ?assertEqual(Tid, ersip_uas:id(UAS0)),

    %% Branch 1: (Retransmit before provisional response is ignored)
    { UAS0, [] } = ersip_uas:event(retransmit, UAS0),

    %% Branch 2: (Sending provisional response)
    { UAS_2_0, SideEffects_2_0 } = ersip_uas:event({send_resp, provisional, resp_msg_prov}, UAS0),
    ...
    { UAS_2_1_0, SideEffects_2_1_0 } = ersip_uas:event(retransmit, UAS_2_0),
    ...
    { UAS_2_1_1, SideEffects_2_1_1 } = ersip_uas:event({send_resp, provisional, resp_msg_prov_1}, UAS_2_1_0),
    SideEffectsMap_2_1_1 = maps:from_list(SideEffects_2_1_1),
    ?assertMatch([resp_msg_prov_1, Tid], maps:get(send, SideEffectsMap_2_1_1)),
    { _, SideEffects_2_1_2 } = ersip_uas:event(retransmit, UAS_2_1_1),
    ...
    { UAS_2_2_0, SideEffects_2_2_0 } = ersip_uas:event({send_resp, final, resp_msg_final}, UAS_2_0),
    ...
    { UAS_3_0, SideEffects_3_0 } = ersip_uas:event({send_resp, final, resp_msg_final}, UAS0),
...
uas_unreliable_test() ->
    ...
    { UAS0, SideEffects0 } = ersip_uas:new(Tid, unreliable, message, #{}),
    SideEffectsMap0 = maps:from_list(SideEffects0),
    %% New transaction is created:
    ?assertMatch([UAS0], maps:get(new_trans, SideEffectsMap0)),
    ?assertMatch([message, Tid], maps:get(tu_result, SideEffectsMap0)),
    ...
    { UAS_1_0, SideEffects_1_0 } = ersip_uas:event({send_resp, final, resp_msg_final}, UAS0),
    ...
    { UAS_1_1, SideEffects_1_1 } = ersip_uas:event(retransmit, UAS_1_0),
    ...
    { UAS_1_1, [] } = ersip_uas:event({send_resp, final, more_final}, UAS_1_1),
    %% Timer J fired => clear transaction
    { UAS_1_2, SideEffects_1_2 } = ersip_uas:event({ timer, timer_j }, UAS_1_1),
